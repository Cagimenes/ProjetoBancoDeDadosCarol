...
namespace ProjetoBancoDados.Controllers
{
    public class ClienteController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeCliente,CpfCliente,TelefoneCliente,EmailCliente")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeCliente,CpfCliente,TelefoneCliente,EmailCliente")] Cliente cliente)
        {
            if (id != cliente.Id)
            {
                return NotFound();
