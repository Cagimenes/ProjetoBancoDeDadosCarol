...
namespace ProjetoBancoDados.Controllers
{
    public class TransporteController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeTansporte")] Transporte transporte)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeTansporte")] Transporte transporte)
        {
            if (id != transporte.Id)
            {
                return NotFound();
