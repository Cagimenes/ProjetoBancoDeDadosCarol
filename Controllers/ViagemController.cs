    ...
    public class ViagemController : Controller
    {
        ...
        public async Task<IActionResult> Imprimir(int? id)
        {
            ...
            viagem.Hospedagem = await _context.Hospedagem
                                        .Include(c => c.Destino)
                                        .Include(c => c.Hotel)
                                        .Where(c => c.HospedagemId == viagem.HospedagemId).FirstAsync();
        ...
        public IActionResult Create()
        {
            ...
            ViewData["HospedagemId"] = new SelectList(_context.Hospedagem, "HospedagemId", "DiasHospedagem");
            ViewData["TransporteId"] = new SelectList(_context.Transporte, "Id", "NomeTansporte");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ClienteId,HospedagemId,TransporteId,PrecoViagem,FormaPagamentoId")] Viagem viagem)
        {
            ...
            ViewData["HospedagemId"] = new SelectList(_context.Hospedagem, "HospedagemId", "DiasHospedagem", viagem.HospedagemId);
            ViewData["TransporteId"] = new SelectList(_context.Transporte, "Id", "NomeTansporte", viagem.TransporteId);
            return View(viagem);
        }
